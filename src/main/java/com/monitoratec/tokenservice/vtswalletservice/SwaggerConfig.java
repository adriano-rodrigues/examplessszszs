...
public class SwaggerConfig {
    private final String applicationName = "FirstTech VTS Wallet API";
    ...
    public Docket newsApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.monitoratec.tokenservice.vtswalletservice.controller"))
    ...
    private Contact contact() {
        return new Contact("FirstTech", "https://first-tech.com/", "developer@first-tech.com");
    }
}
