package com.monitoratec.tokenservice.vtswalletservice.domain.payload.output.provision.token.pan;
...
import com.monitoratec.tokenservice.vtswalletservice.domain.payload.input.provision.token.pan.PassCode;
...
public class ProvisionedTokensForAPanOutputPayload extends ProvisionToken {
    @NotNull
    @Size(max = 5)
